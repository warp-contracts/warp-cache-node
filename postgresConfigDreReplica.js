  ...
  ...(process.env.PG_SSL === 'true'
    ? {
        ssl: {
          ...
          ca: readFileSync('certs/db/replica/ca.pem').toString(),
          key: readFileSync('certs/db/replica/dre/key.pem').toString(),
          cert: readFileSync('certs/db/replica/dre/cert.pem').toString()
        }
      }
    : '')
};
